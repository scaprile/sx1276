...
/* File has been extensively modified to accomodate differences in hardware choices */
 ...
 */
DioIrqHandler *DioIrq[] = { SX1276OnDio0Irq,
#ifdef SX1276_BOARD_DIO1
                            SX1276OnDio1Irq,
#endif
#ifdef SX1276_BOARD_DIO2
...
void SX1276SetRx( uint32_t timeout )
{
    ...
    if( SX1276.Settings.Modem == MODEM_FSK )
    {
        ...
        {
            TimerStart( &RxTimeoutSyncWord, SX1276.Settings.Fsk.RxSingleTimeout );
        }
    }
    else
    {
...
static void SX1276OnTimeoutIrq( void* context )
{
    ...
    case RF_TX_RUNNING:
        ...
        // the radio transceiver and puts it into a known state.
...
static void SX1276OnDio2Irq( void* context )
{
    switch( SX1276.Settings.State )
    {
        case RF_RX_RUNNING:
            ...
            {
            case MODEM_FSK:
#ifndef SX1276_BOARD_DIO4 // if pin DIO4 is not used, force preamble detection true
                SX1276.Settings.FskPacketHandler.PreambleDetected = true;
#endif

                if( ( SX1276.Settings.FskPacketHandler.PreambleDetected != false ) && ( SX1276.Settings.FskPacketHandler.SyncWordDetected == false ) )
                {
                    TimerStop( &RxTimeoutSyncWord );
