...
/* File has been modified to accomodate porting to the current environment */
 ...
 * \note    This function blocks for maxCarrierSenseTime unless it detects channel in use before
 *
